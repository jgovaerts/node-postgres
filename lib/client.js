...
var Client = function(config) {
  ...
  if (this.connectionParameters.search_path) {
    this.query('SET search_path TO ' + this.connectionParameters.search_path, function(err, result) {
      if (err) {
        throw new Error("Error setting search_path: " + err);
      }
    });
  }
};
